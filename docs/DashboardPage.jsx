        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
                        ...
                        dataKey="count"
                      >
                        {dashboardAnalytics.leadSources.map((entry, index) => (
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {dashboardAnalytics.recentLeads.slice(0, 5).map((lead) => (
          ...
          <TabsContent value="leads" className="mt-6">
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {dashboardAnalytics.recentLeads.map((lead) => (
          ...
          <TabsContent value="analytics" className="mt-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {dashboardAnalytics.competitorAnalysis.map((competitor, index) => (
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {dashboardAnalytics.topKeywords.map((keyword, index) => (
                    <div key={index} className="flex items-center justify-between p-3 border rounded">
                      <div>
                  ...
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-lg">{companyProfile.capacity} MW</p>
                      </div>
                      <div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {companyProfile.serviceAreas.map((area, index) => (
