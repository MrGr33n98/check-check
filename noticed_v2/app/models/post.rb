class Post < ApplicationRecord
  ...
  def self.ransackable_attributes(_auth_object = nil)
    %w[title body created_at updated_at published_at views user_id] # Allow searching by title, body, comments  and user
  end

  def self.ransackable_associations(_auth_object = nil)
    %w[user comments] # We don't have any searchable associations in this case
  end
